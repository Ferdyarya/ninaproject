    ...
    <body>
        <div class="container-fluid">
            <div class="card" style="border-radius: 15px;">
                <div class="card-body">
                    <h1 class="text-center mb-4">Edit Data Daerah</h1>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-8">
                                <div class="card" style="border-radius: 10px;">
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('masterdaerah.update', $item->id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label for="namadaerah">Nama Daerah</label>
                                                <input value="{{ $item->namadaerah }}" type="text" name="namadaerah"
                                                    class="form-control" id="exampleInputPassword1"
                                                    placeholder="Masukan Nama Daerah" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $item->budgetperjalanan }}" type="text"
                                                    name="budgetperjalanan" class="form-control" id="exampleInputPassword1"
                                                    placeholder="Masukan Nama Dana Perjalanan" required>
                                            </div>
