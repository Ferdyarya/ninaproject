                  ...
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                  <form method="POST" action="{{ route('masterdaerah.store') }}" enctype="multipart/form-data">
                                      @csrf
                                      <div class="form-group">
                                          <label for="namadaerah">Nama Daerah</label>
                                          <input type="text" name="namadaerah" class="form-control @error('namadaerah') is-invalid @enderror" id="namadaerah"
                                              aria-describedby="emailHelp" placeholder="Masukan namadaerah" value="{{ old('namadaerah') }}" required>
                                          @error('namadaerah')
