                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-2">
                                                ...
                                                @else
                                                    ...
                                                    <form action="{{ route('updateStatusperjalanan', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                            ...
                                            @if (Auth::user()->hakakses('petugas') || Auth::user()->hakakses('admin'))
                                                <td class="px-6 py-2">
                                                    {{-- <a href="{{ route('perjalanan.edit', $item->id) }}"
                                                        class="btn btn-primary">Edit</a> --}}
                                                    <form action="{{ route('perjalanan.destroy', $item->id) }}"
                                                        method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit" class="btn btn-danger">Hapus</button>
                                                    </form>
                                                    <a href="{{ route('perjalanan.detail', $item->id) }}"
