                              ...
                              <div class="card-body">
                                <form method="POST" action="{{ route('perjalanan.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="id_pegawai" id="judulbuku" style="border-radius: 8px;" data-placeholder="Pilih Nama Pegawai">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="id_daerah" id="daerah" style="border-radius: 8px;" data-placeholder="Pilih Daerah Tujuan">
                                            <option></option> <!-- Placeholder untuk select2 -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="perihal" class="form-control @error('perihal') is-invalid @enderror" id="perihal" placeholder="Masukkan Perihal Perjalanan" value="{{ old('perihal') }}" required>
                                        @error('perihal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" placeholder="Masukkan deskripsi perjalanan" value="{{ old('deskripsi') }}" required>
                                        </textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
