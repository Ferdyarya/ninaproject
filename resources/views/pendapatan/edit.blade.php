...
<title>Data Surat Pendapatan</title>
    ...
    <div class="container-fluid">
        <div class="card">
          <div class="card-body" style="border-radius: 15px;">
              <h1 class="text-center mb-4">Edit Data Surat Pendapatan</h1>
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                <form method="POST" action="{{ route('pendapatan.update', $item->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($item->filelaporan)
                                            <p>File saat ini: <a href="{{ url('filelaporan/'.$item->filelaporan) }}" target="_blank">{{ $item->filelaporan }}</a></p>
                                        @endif
                                    </div>
