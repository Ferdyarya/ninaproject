...
<title>Data Surat Penyetopan Anggaran Daerah</title>
    ...
    <div class="container-fluid">
        <div class="card">
          <div class="card-body" style="border-radius: 15px;">
              <h1 class="text-center mb-4">Edit Data Surat Penyetopan Anggaran Daerah</h1>
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                <form method="POST" action="{{ route('penyetopan.update', $item->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $item->jumlahdana }}" type="number" name="jumlahdana" class="form-control" required>
                                    </div>
