            ...
            <div class="card-body">
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h3 class="m-0">Laporan Data Surat Perjalanan Dinas</h3>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Laporan Data Surat Perjalanan Dinas</li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div>
              ...
              <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /> --}}
                    ...
                    <div class="container">
                        <form action="{{ route('laporanperjalanan') }}" method="GET" class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2 pt-4">
                                @if (!empty($filter))
                                    <a href="{{ route('laporanperjalananpdf', $filter) }}"
                                        class="btn btn-danger btn-block">Export PDF</a>
                                @else
                                    <a href="{{ route('laporanperjalananpdf', 'all') }}"
                                        class="btn btn-danger btn-block">Export PDF</a>
                                @endif
                            </div>
                        </form>
                            ...
                            <tbody>
                              ...
                              @endphp --}}
                                @foreach ($laporanperjalanan as $index => $item)
                                    <tr>
                                        <th class="px-6 py-2">{{ $index + $laporanperjalanan->firstItem() }}</th>
                                        ...
                                        <td class="px-6 py-2">Rp {{ number_format($item->masterdaerah->budgetperjalanan) }}</td>
