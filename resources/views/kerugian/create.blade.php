...
<title>Surat Kerugian Anggaran Daerah</title>
...
<body>
    <div class="container-fluid">
        <div class="card" style="border-radius: 15px;">
          <div class="card-body">
              <h1 class="text-center mb-4">Tambah Data Surat Kerugian Anggaran Daerah</h1>
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-8">
                          <div class="card" style="border-radius: 10px;">
                              <div class="card-body">
                                <form method="POST" action="{{ route('kerugian.store') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="form-group mb-3">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input  type="number" name="jumlahkerugian" class="form-control @error('jumlahkerugian') is-invalid @enderror" id="jumlahkerugian" placeholder="Masukkan Jumlah Kerugian" value="{{ old('jumlahkerugian') }}" required>
                                      @error('jumlahkerugian')
                                          <div class="invalid-feedback">{{ $message }}</div>
                                      @enderror
                                  </div>
                                  <div class="form-group">
